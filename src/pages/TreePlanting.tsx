...
export const TreePlanting: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            import('../wallet/contractManager').then(async ({ contractManager }) => {
                await contractManager.plantTree(
                    formData.treeType,
                    formData.location || '-1.2921, 36.8219',
                    'https://example.com/tree.jpg' // Placeholder for now, would be IPFS hash
                );
                ...
                setIsSubmitting(false);
                alert("Transaction failed! Ensure you are connected to Harmony Testnet.");
            });
        } catch (error) {
